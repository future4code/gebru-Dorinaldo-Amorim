...
const App = () => {
  ...
  const carregaPerfil = () => {
    ...
    axios
    .get("https://us-central1-missao-newton.cloudfunctions.net/astroMatch/dorinaldo-amorim-gebru/person")
    .then(resposta=>{
  ...
  const carregaLista = () =>{
    axios
    .get("https://us-central1-missao-newton.cloudfunctions.net/astroMatch/dorinaldo-amorim-gebru/matches")
    .then(resposta =>{
  ...
  const limparSwipes = () => {
    axios
      .put("https://us-central1-missao-newton.cloudfunctions.net/astroMatch/dorinaldo-amorim-gebru/clear")
      .then(resposta =>{
  ...
  return (
    <DivApp>
        ...
        <button onClick={limparSwipes}>Limpar swipes/matches</button>
    </DivApp>
  );
}
