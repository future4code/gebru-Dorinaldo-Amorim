...
import {DivInicio, DivPerfil, Blur, FotoPerfil, DivDados, NomePerfil, IdadePerfil, Descricao, DivEscolhas, Botao, Coracao, keyframesCoracao,} from "./InicioStyled.js"
...
const Inicio = (props) => {
  ...
  const onClickCurtida = (curtiu) => {
    ...
    axios
      .post(
        "https://us-central1-missao-newton.cloudfunctions.net/astroMatch/dorinaldo-amorim-gebru/choose-person", 
        body
      )
      .then(resposta=>{
